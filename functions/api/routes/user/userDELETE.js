...
const { userDB, memberDB, issueDB, feedbackDB, linkFeedbacKeywordDB, keywordDB } = require('../../../db');
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    /** 너소서 폼 삭제
     *
     * 1. 링크 폼 유저 테이블에서 해당 유저 정보 전부 삭제,
     * 2. 해당 유저가 받은 답변 전부 삭제, 키워드 삭제(link 테이블, 키워드 테이블에서 삭제)
     * */
    throw Error('ㅎㅎ');
