...
const getAllIssueByTeamId = async (client, teamId) => {
  const { rows } = await client.query(
    `
    SELECT i.id, c.name as category_name, i.created_at, i.content,
    t.name as team_name, u.name as user_name
...
module.exports = { getIssueIdRecentListByUserId, getIssueByIssueId, getAllFeedbackPersonList, getAllIssueByTeamId };
